...
type BoardUsecase interface {
	...
	UpdateBoard(ctx context.Context, userID int, boardID int, data models.BoardRequest) (updatedBoard *models.Board, err error)
	...
	CreateNewCard(ctx context.Context, userID int, boardID int, data *models.CardPatchRequest) (newCard *models.Card, err error)
	UpdateCard(ctx context.Context, userID int, boardID int, cardID int, data *models.CardPatchRequest) (updatedCard *models.Card, err error)
...
type BoardRepo interface {
	...
	UpdateBoard(ctx context.Context, boardID int, userID int, data *models.BoardRequest) (updatedBoard *models.Board, err error)
	...
	UpdateCard(ctx context.Context, boardID int, cardID int, data models.CardPatchRequest) (updateCard *models.Card, err error)
