...
type BoardUsecase interface {
	...
	CreateNewCard(userID int, boardID int, data *models.CardPatchRequest) (newCard *models.Card, err error)
	UpdateCard(userID int, boardID int, cardID int, data *models.CardPatchRequest) (updatedCard *models.Card, err error)
...
type BoardRepo interface {
	...
	UpdateCard(boardID int, cardID int, data models.CardPatchRequest) (updateCard *models.Card, err error)
