...
type BoardUsecase interface {
	...
	CreateNewTag(ctx context.Context, userID int64, boardID int64, data *models.TagPatchRequest) (newTag *models.Tag, err error)
	UpdateTag(ctx context.Context, userID int64, tagID int64, data *models.TagPatchRequest) (updatedTag *models.Tag, err error)
	...
	DeassignTagFromCard(ctx context.Context, userID int64, tagID int64) (err error)
}
...
type BoardRepo interface {
	...
	GetMemberFromTag(ctx context.Context, userID int64, tagID int64) (role string, cardID int64, boardID int64, err error)
	...
	CreateNewTag(ctx context.Context, boardID int64, data *models.TagPatchRequest) (newTag *models.Tag, err error)
	UpdateTag(ctx context.Context, tagID int64, data *models.TagPatchRequest) (updatedTag *models.Tag, err error)
