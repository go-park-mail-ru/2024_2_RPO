...
type BoardElasticRepo interface {
	...
	DeleteCard(ctx context.Context, cardID int64) (err error)
	CreateCard(ctx context.Context, boardID int64, cardID int64, cardTitle string) error
	UpdateCard(ctx context.Context, boardID int64, cardID int64, cardTitle string) error
}
