...
func (mr *MockAuthUsecaseMockRecorder) LoginUser(email, password interface{}) *gomock.Call {
...
func (mr *MockAuthUsecaseMockRecorder) LogoutUser(sessionId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthUsecaseMockRecorder) RegisterUser(user interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) CheckUniqueCredentials(nickname, email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) CreateUser(user, hashedPassword interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) KillSessionRedis(sessionId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) RegisterSessionRedis(cookie, userID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) RetrieveUserIdFromSessionId(sessionId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAuthRepoMockRecorder) SetNewPasswordHash(userID, newPasswordHash interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
