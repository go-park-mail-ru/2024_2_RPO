...
func (c *authClient) CreateSession(ctx context.Context, in *UserDataRequest, opts ...grpc.CallOption) (*Session, error) {
...
func _Auth_CreateSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).CreateSession(ctx, req.(*UserDataRequest))
	}
