...
CREATE TABLE User_to_Board (
    ub_id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY
    u_id INT NOT NULL,
    b_id INT NOT NULL,
...
CREATE TABLE Card (
    crd_id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    col_id INT NOT NULL,
    title TEXT NOT NULL,
    order_index INT,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE Card_to_Tag(
    ct_id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    crd_id INT NOT NULL,
    t_id INT NOT NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE CardUpdate (
    cu_id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    crd_id INT NOT NULL,
...
CREATE TABLE CardPinnedFile (
    cpf_id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    crd_id INT NOT NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    created_by INT NOT NULL,
    url TEXT NOT NULL,
...
CREATE TABLE Notification (
    n_id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    u_id INT NOT NULL,
    b_id INT NOT NULL,
...
CREATE TABLE CheckListField (
    cls_id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    crd_id INT NOT NULL,
